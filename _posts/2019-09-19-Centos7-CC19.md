...
基于pbs作业系统的集群，支持NIS，NFS服务，slurm的后期有时间补上。
本文最初发在[Centos 7 集群搭建](https://github.com/cndaqiang/E5-PC-daily/issues/6)
...
vim /etc/yp.conf
```
添加`domain CC19   broadcast`，指定服务器地址也行
```
...
配置文件(计算节点)
```
vi /opt/CC19/torque6/server_priv/nodes
